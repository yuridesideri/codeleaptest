			...
			{showModal &&
				createPortal(
					<Modal closeModal={() => setShowModal(false)}>
						...
						>
							<h1 className="text-[22px] font-bold text-white dark:text-white">
								What's on your mind?
							</h1>
							...
							<div className="flex flex-col">
								...
								<textarea
									...
									className="h-[74px] resize-none rounded-lg border border-black pl-3 pt-2 leading-4 outline outline-1 transition-all duration-200 ease-in-out placeholder:text-placeholderText dark:placeholder:text-placeholderTextDark"
								/>
							</div>
							<div className="buttons flex gap-4 self-end">
								...
								<StyledButton
									...
									className="mt-0 flex h-[32px] w-[120px] items-center justify-center rounded-[8px] border font-bold text-white dark:text-black"
								>
									Save
								</StyledButton>
							</div>
